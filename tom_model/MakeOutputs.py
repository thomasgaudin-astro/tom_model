...
class MakeOutputs:
    ...
    def __init__(self, competition, average_total_table, average_placement_table=None, group=None):

        if (average_placement_table) & (group):
            plot_avg_placements(competition, average_placement_table, group)

    def plot_avg_placements(self, competition, average_placement_table, group):
